...
public class ListNoticeController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<NoticeVO> notList = notService.listAllNotice();
		...
		int countList = notService.countList();
		...
		List<NoticeVO> list = notService.noticeList(map);
		...
		req.getRequestDispatcher("/notices/notice/notList.jsp").forward(req, resp);
	}
