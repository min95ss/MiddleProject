...
<body>
	<div data-testid="cart-view" data-component="CartView" class="body-container">
			...
			<div class="css-1n8met0">
				<div class="css-s45c7f" data-component="StorePageContent">
					<div class="css-1sqqqs8" data-component="StorePage">
						<section class="css-1q9jlv0" data-testid="section-wrapper" data-component="SectionWrapper">
							<div class="css-yewo14" data-testid="section-wrapper-content" data-component="SectionWrapperContent">
								...
								<!-- 장바구니 본문 영역 -->
								<%
									boolean emptyCartChk = selectCartList.isEmpty();
								%>
								<%
								...
								<div class="css-map4tx">
									<div class="css-11fvpc2">
											...
											<div data-testid="offer-card-layout-wrapper">
												<div class="css-h8tfh5">
													<div class="css-id4ofr">
															<a class="css-1nvf6h0" role="link" href="/detailGame.do?id=<%=gameInfoList.get(i).getGameId()%>">
														<div class="css-fybeq" data-testid="image-desktop">
																<div class="css-167dhte">
																	<div class="css-yb58t8">
																		<div class="css-han5dv">
																			<img class="css-11h61hf" alt="" src="<%=gameInfoList.get(i).getGameImg()%>" data-animated="animated" data-image="<%=gameInfoList.get(i).getGameImg()%>" data-testid="lazy-image-observer" data-component="BaseImage">
																		</div>
																	</div>
																</div>
														</div>
															...
															<div class="css-rosb62">
																<div class="css-z5atxi">
																	...
																	<div class="css-14mezjk">
																		<a class="css-qcw33g" role="link" href="/detailGame.do?id=<%=gameInfoList.get(i).getGameId()%>"><h2 class="css-12d0yut" data-component="Heading">
																				<div class="css-vetbs0" data-component="LineClamp">
																					<div class="css-8uhtka" data-testid="one-line-text"><%=gameInfoList.get(i).getGameName()%></div>
																				</div>
																			</h2></a>
																	</div>
																</div>
																	...
																	<div class="css-1ehhp1w">
																		...
																		<div class="css-fhxb3m" data-component="PriceLayout">
																			<span class="css-157lcjk">
																				...
																				<div class="css-l24hbj">
																					<span class="css-z3vg5b">₩<%=gameInfoList.get(i).getGamePrice()%></span>
																				</div>
																			</span>
																		</div>
																				...
																				<div class="css-l24hbj">
																					<span class="css-11ksoqt">
																						<div class="css-1rcj98u">
																							₩<%=gameInfoList.get(i).getGamePrice()%></div>
																					</span>
																				</div>
																				<div class="css-l24hbj">
																	...
																	<div class="css-vs1xw0">
																		<div class="css-7whenc">
																			<div class="css-1f1kwdk">
																				<%
																					String srcImg = "";
																				String age = gameInfoList.get(i).getAgeGrade();
																			...
																			<div>
																				<div class="css-cgc87z">
																					<span class="css-25dfdw"><%=gameInfoList.get(i).getAgeGrade()%></span>
																				</div>
																		...
																		<div class="css-kopxry">
																			<ul class="css-e6kwg0">
																				...
																				<li class="css-1nau1p3"><span class="css-staqnu" aria-hidden="true"> <svg xmlns="http://www.w3.org/2000/svg" class="svg css-w1atjl" viewBox="0 0 512 512">
																							...
																							<path fill="currentColor" d="M0.175 256l-0.175-156.037 192-26.072v182.109zM224 69.241l255.936-37.241v224h-255.936zM479.999 288l-0.063 224-255.936-36.008v-187.992zM192 471.918l-191.844-26.297-0.010-157.621h191.854z"></path></g></svg></span></li>
																				<!-- 맥OS -->
																...
																<div class="css-hf0z5i">
																	<div class="css-4kb9lt">
																		...
																		<div class="css-tg7p45">
																			<button class="css-1yu35vh" onClick="location.href='deleteCart.do?gameId=<%=selectGameList.get(i)%>'">
																				<div class="css-s5xdrg">
																					<span class="css-z3vg5b"> <span class="css-gdh3kc">삭제</span></span>
																				</div>
																			</button>
																		</div>
																	</div>
										...
										<%
											// discount 가격을 토탈에서 도로 빼버리자
										totalPrice += Integer.parseInt((gameInfoList.get(i).getGamePrice()));
									...
									<div class="css-1791idi">
										<div class="css-1fttcpj">
											<div class="css-fvtxyy">
												<span class="css-mywzwd"> <span>게임 및 앱 합계</span></span>
											</div>
											...
											<div class="css-sdue89">
												<div class="css-1eoy87d">
													<div class="css-3d5xom">
														<span class="css-z3vg5b"> <span>할인 금액</span></span>
													</div>
													<%
														int salePrice = 0;
													for (DiscountVO vo : discountList) {
														salePrice += vo.getGamePrice();
													}
													%>
													<span class="css-z3vg5b">-₩<%=salePrice%></span>
												</div>
											</div>
											...
											<div class="css-u9q8d2">
												<div class="css-1eoy87d">
													<div class="css-3d5xom">
														<span class="css-b3sav2"> <span>소계</span></span>
													</div>
													<%
														for (DiscountVO vo : discountList) {
														totalPrice -= vo.getGamePrice();
													}
													%>
													<span class="css-b3sav2">₩<%=totalPrice%></span>
												</div>
											</div>
											<!-- 구매하기 버튼 영역 -->
											<div class="css-1fkya4n">
												<button class="css-20a60t" data-toggle="modal" data-target="#reviewModal" aria-disabled="false" onclick="location.href='../orderController.do?totalPrice=<%=totalPrice%>'">
													<span>구매하기</span>
												</button>
											</div>
										</div>
									...
									<div class="css-11fvpc2">
										<div class="css-zigog8">
											...
											<div class="css-cn3xcj">
												<span class="css-mywzwd" data-component="Text"> <span>장바구니가 비어 있습니다.</span></span>
											</div>
											<div>
...
$("#btnOK").click(function(){  
    $.ajax({      
        type:"GET",  
        url:"/orderController.do?totalPrice=<%=totalPrice%>",   
