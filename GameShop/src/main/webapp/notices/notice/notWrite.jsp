...
<body id="notWContainer" class="sb-nav-fixed">
			...
			<div class="card-body">
					<div class="mb-3 mt-3">
						<label for="title" class="form-label">제목</label> <input
							type="text" class="form-control" id="title" name="notTitle" style="background: #ddd; color:#121212;"
							value="" required>
					</div><hr>
					<div class="mb-3">
						<label for="content" class="form-label">내용</label>
						<textarea id="summernote" class="form-control" id="content" name="notCont" required></textarea>
					</div>
<!-- 					<div class="mb-3"> -->
...
<!-- 						<label for="num" class="form-label">글번호</label>  -->
						<input type="text" class="form-control" id="num" name="notId"
							value="" hidden>
					</div>
